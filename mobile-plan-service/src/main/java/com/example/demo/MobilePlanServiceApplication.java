...
public class MobilePlanServiceApplication {
	...
	/*
	 * In springs by default Beans are Eagerly Created. We can also make them create
	 * lazily by adding annotation @Lazy.
	 * 
	 * Beans are singleton by default
	 * If they are not singleton they are prototype
	...
	public static void main(String[] args) {
		...
		System.out.println("isSingleton :="+ctx.isSingleton("mobilePlan"));
