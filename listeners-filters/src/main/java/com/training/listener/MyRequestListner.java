...
public class MyRequestListner implements ServletRequestListener, ServletRequestAttributeListener {
    ...
    public void attributeAdded(ServletRequestAttributeEvent srae)  { 
         // TODO Auto-generated method stub
    	System.out.println("Attribute with name"+ srae.getName()+"value"+srae.getValue()+"Added");
    }
    ...
    public void attributeReplaced(ServletRequestAttributeEvent srae)  { 
         // TODO Auto-generated method stub
    	System.out.println("Attribute with name"+ srae.getName()+"value"+srae.getValue()+"Replaced");
    }
